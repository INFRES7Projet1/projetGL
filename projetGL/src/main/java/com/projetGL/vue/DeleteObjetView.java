 ...
 * @author Rémy
 */
public class DeleteObjetView extends javax.swing.JFrame {
    ...
    public DeleteObjetView() {
        initComponents();
        objetdao = new ObjetDAO();
        List<Objet> listobjets;
        listobjets = objetdao.findListe();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ID de l'objet à supprimer");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteObjetView().setVisible(true);
            }
        });
    }
