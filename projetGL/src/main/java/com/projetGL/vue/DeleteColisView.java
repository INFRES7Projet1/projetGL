...
public class DeleteColisView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ID du colis à supprimer");
    ...
    private void jButtonSupprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerActionPerformed
        ...
        colisdao.DeleteColisFromMedicamentColis(colis.Id);
        colisdao.DeleteColisFromOutilColis(colis.Id);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteColisView().setVisible(true);
            }
        });
    }
