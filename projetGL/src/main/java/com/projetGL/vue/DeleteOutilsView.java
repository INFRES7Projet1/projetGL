 ...
 * @author Rémy
 */
public class DeleteOutilsView extends javax.swing.JFrame {

    private static ColisDAO colisdao;
    private static Colis colis;
    private static OutilDAO outilsdao;
    private static Outil outil;
    
    public DeleteOutilsView() {
        initComponents();
        outilsdao = new OutilDAO();
        List<Outil> listoutils;
        listoutils = outilsdao.findListe();
        for(Outil outil : listoutils)
        {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ID de l'outil à supprimer");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteOutilsView().setVisible(true);
            }
        });
    }
