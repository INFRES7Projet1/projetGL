 ...
 * @author Rémy
 */
public class DeleteMedicamentView extends javax.swing.JFrame {

    private static ColisDAO colisdao;
    private static Colis colis;
    private static MedicamentDAO medocdao;
    private static Medicament medocs;
    
    public DeleteMedicamentView() {
        initComponents();
        medocdao = new MedicamentDAO();
        List<Medicament> listmedocs;
        listmedocs = medocdao.findListe();
        for(Medicament medoc : listmedocs)
        {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ID du médicament à supprimer");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteMedicamentView().setVisible(true);
            }
        });
    }
